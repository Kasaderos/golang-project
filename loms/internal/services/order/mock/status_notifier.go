...
type StatusNotifierMock struct {
	...
	funcNotifyOrderStatus          func(m models.OrderID, status models.Status) (err error)
	inspectFuncNotifyOrderStatus   func(m models.OrderID, status models.Status)
...
func (mmNotifyOrderStatus *mStatusNotifierMockNotifyOrderStatus) Expect(m models.OrderID, status models.Status) *mStatusNotifierMockNotifyOrderStatus {
	...
	mmNotifyOrderStatus.defaultExpectation.params = &StatusNotifierMockNotifyOrderStatusParams{m, status}
...
func (mmNotifyOrderStatus *mStatusNotifierMockNotifyOrderStatus) Inspect(f func(m models.OrderID, status models.Status)) *mStatusNotifierMockNotifyOrderStatus {
...
func (mmNotifyOrderStatus *mStatusNotifierMockNotifyOrderStatus) Set(f func(m models.OrderID, status models.Status) (err error)) *StatusNotifierMock {
	if mmNotifyOrderStatus.defaultExpectation != nil {
...
// Then helper
func (mmNotifyOrderStatus *mStatusNotifierMockNotifyOrderStatus) When(m models.OrderID, status models.Status) *StatusNotifierMockNotifyOrderStatusExpectation {
	if mmNotifyOrderStatus.mock.funcNotifyOrderStatus != nil {
		mmNotifyOrderStatus.mock.t.Fatalf("StatusNotifierMock.NotifyOrderStatus mock is already set by Set")
	}
	...
	expectation := &StatusNotifierMockNotifyOrderStatusExpectation{
		...
		params: &StatusNotifierMockNotifyOrderStatusParams{m, status},
	}
...
func (mmNotifyOrderStatus *StatusNotifierMock) NotifyOrderStatus(m models.OrderID, status models.Status) (err error) {
	...
	if mmNotifyOrderStatus.inspectFuncNotifyOrderStatus != nil {
		mmNotifyOrderStatus.inspectFuncNotifyOrderStatus(m, status)
	}

	mm_params := &StatusNotifierMockNotifyOrderStatusParams{m, status}
	...
	if mmNotifyOrderStatus.NotifyOrderStatusMock.defaultExpectation != nil {
		...
		mm_got := StatusNotifierMockNotifyOrderStatusParams{m, status}
	...
	if mmNotifyOrderStatus.funcNotifyOrderStatus != nil {
		return mmNotifyOrderStatus.funcNotifyOrderStatus(m, status)
	}
	mmNotifyOrderStatus.t.Fatalf("Unexpected call to StatusNotifierMock.NotifyOrderStatus. %v %v", m, status)
	return
}
