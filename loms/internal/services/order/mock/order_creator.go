...
// OrderCreatorMock implements order.OrderCreator
type OrderCreatorMock struct {
	t minimock.Tester

	funcCreateOrder          func(ctx context.Context, order models.Order) (o1 models.OrderID, err error)
	inspectFuncCreateOrder   func(ctx context.Context, order models.Order)
	afterCreateOrderCounter  uint64
	beforeCreateOrderCounter uint64
	CreateOrderMock          mOrderCreatorMockCreateOrder
}

// NewOrderCreatorMock returns a mock for order.OrderCreator
...
func (mmCreateOrder *mOrderCreatorMockCreateOrder) Expect(ctx context.Context, order models.Order) *mOrderCreatorMockCreateOrder {
	...
	mmCreateOrder.defaultExpectation.params = &OrderCreatorMockCreateOrderParams{ctx, order}
...
func (mmCreateOrder *mOrderCreatorMockCreateOrder) Inspect(f func(ctx context.Context, order models.Order)) *mOrderCreatorMockCreateOrder {
...
func (mmCreateOrder *mOrderCreatorMockCreateOrder) Set(f func(ctx context.Context, order models.Order) (o1 models.OrderID, err error)) *OrderCreatorMock {
	if mmCreateOrder.defaultExpectation != nil {
...
// Then helper
func (mmCreateOrder *mOrderCreatorMockCreateOrder) When(ctx context.Context, order models.Order) *OrderCreatorMockCreateOrderExpectation {
	if mmCreateOrder.mock.funcCreateOrder != nil {
		mmCreateOrder.mock.t.Fatalf("OrderCreatorMock.CreateOrder mock is already set by Set")
	}
	...
	expectation := &OrderCreatorMockCreateOrderExpectation{
		...
		params: &OrderCreatorMockCreateOrderParams{ctx, order},
	}
...
// CreateOrder implements order.OrderCreator
func (mmCreateOrder *OrderCreatorMock) CreateOrder(ctx context.Context, order models.Order) (o1 models.OrderID, err error) {
	...
	mm_params := &OrderCreatorMockCreateOrderParams{ctx, order}
	...
	if mmCreateOrder.CreateOrderMock.defaultExpectation != nil {
		...
		mm_got := OrderCreatorMockCreateOrderParams{ctx, order}
	...
	mmCreateOrder.t.Fatalf("Unexpected call to OrderCreatorMock.CreateOrder. %v %v", ctx, order)
	return
}
